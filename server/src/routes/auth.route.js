...
import { checkAuth, deleteAccount, deleteUserProfile, getUserProfile, login, profile, signup } from '../controllers/auth.controller.js';
...
authRouter.get('/check', authProtector, checkAuth);
