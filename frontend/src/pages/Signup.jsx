...
function Signup() {
  ...
  return (
    <div className='container h-screen flex justify-center items-center flex-col space-y-7 ' > 
      <div className='flex justify-center items-center flex-col space-y-[-70px] ' >
        <img src="voicely.png" alt="logo" className='h-[200px] w-[200px] md:h-[300px] md:w-[300px] ' />
        <h1 className='text-2xl md:text-4xl lg:text-7xl font-stretch-expanded font-bold ' >Welcome to Voicely</h1>
      </div>
      ...
      <div className="form-control" >
            ...
            <button type="submit" 
            className="btn btn-primary w-full" disabled={isSigning} >
              {
                isSigning ? (
                  <>
